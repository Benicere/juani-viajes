          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-8 justify-center lg:justify-start">
              <a
                ...
                className="inline-flex items-center justify-center px-8 py-4 bg-[color:var(--color-primary)] text-black font-semibold rounded-lg hover:bg-[color:var(--color-primary)]/90 transition-colors"
              >
